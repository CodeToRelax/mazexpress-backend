...
const getWarehouses = async () => {
    try {
        ...
        throw new error_middleware_1.CustomErrorHandler(types_1.StatusCode.CLIENT_ERROR_BAD_REQUEST, 'common.getWarehouseError', 'errorMessageTemp', error);
    }
};
const createWarehouse = async (body) => {
    try {
        ...
        throw new error_middleware_1.CustomErrorHandler(types_1.StatusCode.CLIENT_ERROR_BAD_REQUEST, 'common.createWarehouseError', 'errorMessageTemp', error);
    }
};
const updateWarehouse = async (_id, body) => {
    try {
        ...
        throw new error_middleware_1.CustomErrorHandler(types_1.StatusCode.CLIENT_ERROR_BAD_REQUEST, 'common.warehouseUpdateError', 'errorMessageTemp', error);
    }
};
